      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item active  ">
            <a class="nav-link" href="{{url('sagent/dashboard')}}">
              <i class="material-icons">dashboard</i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="{{url('sagent/merchant')}}">
              <i class="material-icons">person</i>
              <p> Transaction history</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="{{url('sagent/withdrawal')}}">
      ...
      <footer class="footer">
        <div class="container-fluid">
          <nav class="float-left">
            <ul>
              <li>
                <a href="https://flingex.com/contact-us">
                  Contact FlingEX
                </a>
              </li>
            </ul>
          ...
          <div class="copyright float-right">
            ...
            <a href="https://www.evertechit.com" target="_blank">Evertech IT</a>
          </div>
        </div>
      </footer>
    </div>
  ...
  <div class="fixed-plugin">
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        <li class="header-title"> Select Color</li>
