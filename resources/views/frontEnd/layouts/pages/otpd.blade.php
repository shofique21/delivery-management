                    ...
                    <div class="card-body bg-success">
                        <form method="POST" action="{{ route('loginOtp') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label h1 text-md-right">{{ __('Mobile No') }}</label>
                            ...
                            <div class="form-group row dotp">
                                <label for="password" class="col-md-4 col-form-label h1 text-md-right">OTP</label>
                        ...
                        <div class="form-group row dsend-otp">
                            <div class="col-md-8 offset-md-4">
                                <button class="btn btn-dark btn-sm" type="submit" onclick="dsendOtp()">Send OTP</button>
                            </div>
                        </div>
                    </div>
                </div>
