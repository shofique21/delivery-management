                    ...
                    <div class="card custom-card">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 p-5">
                            <div class="row">
                                ...
                                <div class="col">
                            <form action="{{url('editor/export')}}" method="get">
                            @csrf
                                <select name="status" id="status" class="form-control">
                                    <option value="">Select Status</option>
                                                ...
                                                <option value="10">Return to Central Hub</option>
                                            </select>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <button type="submit" name="filter" id=ers"
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <select name="status" class="form-control" id="sstatus" required>
                                            ...
                                            <div class="form-group mrt-15">
                                                <select name="snote" id="snote" class="form-control" required>
                                            ...
                                            <!-- form group end -->
                                            <div class="form-group">
                                                <button  id="updateStatus" data-dismiss="modal"
...
$(document).ready(function() {
    ...
    $(function load_data(filter_id='',trackId = '', phoneNumber = '', merchantId = '',status='', startDate = '', endDate = '') {
        ...
        // lengthMenu: [
        //     [100, 150, 250, -1],
        //     ['100 rows', '150 rows', '250 rows', 'Show all']
        // ],
        
        "lengthMenu": [
                 [5, 50,100, 150, 250,300 ,500,1000,-1],
                 [5,50, 100, 150, 250,300,500,1000,"All"] // change per page values here
            ],
        "dom": 'Blfrtip',
        "buttons": [
        ...
        serverSide: true,
            ...
            // load_data();
            ajax: {
                url: '{{ url("editor/parcel/all-parcel") }}',
                data: {
                    filter_id: filter_id,
                    trackId: trackId,
