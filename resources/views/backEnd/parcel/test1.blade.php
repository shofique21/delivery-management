                                            ...
                                            <div class="form-group">
                                                <div class="customerpaid" style="display: none;">
                                                    <input type="text" class="form-control"
                                                        value="{{old('customerpay')}}" id="customerpay"
...
$(document).ready(function() {
    ...
    $(function load_data(filter_id='',trackId = '', phoneNumber = '', merchantId = '', startDate = '', endDate = '') {
        // load_data();
        ...
        // $('.input').click(function() {
           $('.input').on('keyup', function(e) {
            ...
            // $('#startDate').val(null);
            // $('#endDate').val(null);
            if (filter_id != null ||trackId != null || phoneNumber != null || merchantId != '' || startDate !=
                null && endDate != null) {
               
                $('#dataexample').DataTable().destroy();
                load_data(filter_id,trackId, phoneNumber, merchantId, startDate, endDate);
