                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="description">Description</label>
                              <textarea type="text" class="summernote form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" value="{{ old('description') }}" name="description">{!!$edit_data->description !!}</textarea>
