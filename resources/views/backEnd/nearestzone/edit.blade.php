              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Nearestzone Edit Instructions</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                       ...
                       <input type="hidden" value="{{$edit_data->id}}" name="hidden_id">
                        <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="zonename">Hub Name</label>
                                                    <select name="hub_id" id=""
                                                        class="form-control {{ $errors->has('hub_id') ? ' is-invalid' : '' }}">
                                                        @foreach ($hub as $h)
                                                        <option <?php if ($h->id == $edit_data->hub_id) {
                                                         echo "selected";
