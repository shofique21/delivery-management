...
use App\Http\Middleware\SagentMiddleware;
use App\Http\Middleware\DeliverymanAuth;
use App\Http\Middleware\MerchantAuthApi;
use App\Http\Middleware\DeliverymanAuthApi;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'sagent'=> SagentMiddleware::class, 
        'agentauth'=> AgentAuth::class,
        'deliverymanauth'=> DeliverymanAuth::class,
        'merchantauthapi'=> MerchantAuthApi::class,
        'deliverymanauthapi'=> DeliverymanAuthApi::class,
